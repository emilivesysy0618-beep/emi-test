import { auth, db, doc, getDoc, getRedirectResult, googleProvider, onAuthStateChanged, serverTimestamp, setDoc, signInWithPopup, signInWithRedirect, signOut } from "./firebase.js?v=1858cce";
